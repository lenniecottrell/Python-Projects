...
class ParentWindow(Frame):
    def __init__ (self, *args, **kwargs):
        ...
        self.b1 = tk.Button(win, width=12, text="Source...", command=lambda: Script_GUI_Challenge_func.selectFolder1(self))
        self.b2 = tk.Button(win, width=12, text="Destination...", command=lambda: Script_GUI_Challenge_func.selectFolder2(self))
